  ...
  return (
    <div className="baseline-budget">
      <div className="label-wrapper">
        <div className="label">{`Baseline [${budgetFrequency}] Budget`}</div>
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
      ...
      <input
        className="radiused-light p-10-16 h-40"
        id="baseline-budget-input"
        type="text"
        disabled={budgetAllocation === "Manual" ? "disabled" : null}
        value={baselineBudget ? parseFloat(baselineBudget).toLocaleString() : 0}
